...
class ClaimsControllerTest < ActionController::TestCase
  ...
  test "creating a claim on an autogenerated dataset" do
    owner = FactoryGirl.create(:user)
    initiating_user = FactoryGirl.create(:user)
    certificate = FactoryGirl.create(:autogenerated_published_certificate_with_dataset)
  ...
  test "cannot claim a self certified dataset" do
    owner = FactoryGirl.create(:user)
    initiating_user = FactoryGirl.create(:user)
