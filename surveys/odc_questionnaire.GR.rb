survey 'GR',
  ...
  section_general 'Γενικές Πληροφορίες',
    ...
    q_dataTitle 'Πώς ονομάζεται αυτό το δεδομένο;',
    ...
    q_publisher 'Ποιος δημοσιεύει αυτά τα δεδομένα;',
      ...
      :help_text => 'Δώστε το όνομα του οργανισμού που εκδίδει αυτά τα δεδομένα. Είναι πιθανώςο οργανισμός για τον οποίο εργάζεστε εκτός και αν το κάνετε αυτό για λογαριασμό κάποιου άλλου.',
      :required => :required
  ...
  section_practical 'Πρακτικές πληροφορίες',
    ...
    a_true 'Ναι, αυτά τα δεδομένα θα γίνουν ξεπερασμένα (out of date)',
      ...
      :help_text => 'Για παράδειγμα, ένα σύνολο δεδομένων των τοποθεσιών των στάσεων λεωφορείου με τη πάροδο του χρόνου θα θεωρείται ανημέρωτο(out of date) καθώς θα μεταβάλλονται θα δημιουργούνται καινούριες.'
    ...
    a_false 'Όχι, αυτά τα δεδομένα δεν περιέχουν χρονικά ευαίσθητες πληροφορίες',
      ...
      :help_text => 'Για παράδειγμα, τα αποτελέσματα ενός πειράματος θα παραμείνουν ενήμερα, διότι τα δεδομένα περιγράφουν με ακρίβεια τα παρατηρούμενα αποτελέσματα.',
    ...
    q_qualityControlUrl 'Πού περιγράφεται η διαδικασία ποιοτικού ελέγχου σας;',
      ...
      :help_text => 'Δώστε μια διεύθυνση URL ώστε οσοι επιθυμούν να μάθουν για τους συνεχείς ελέγχους στα δεδομένα σας, είτε αυτόματα ή χειροκίνητα. Αυτό τους διαβεβαιώνει ότι λαμβάνετε σοβαρά υπόψη την ποιότητα και ενθαρρύνει τις βελτιώσεις που ωφελούν όλους.'
    ...
    a_short 'είναι διαθέσιμα δοκιμαστικά, αλλά θα παραμείνουν για άλλο ένα έτος ή περίπου',
    ...
    a_long 'είναι μέρος των καθημερινών σας εργασιών έτσι θα μείνει δημοσιευμένο για μεγάλο χρονικό διάστημα',
  ...
  section_technical 'Τεχνικές Πληροφορίες',
    ...
    q_machineReadable 'Είναι αυτά τα δεδομένα αναγνώσιμα από τη μηχανή;',
      ...
      :help_text => 'Οι άνθρωποι προτιμούν μορφές δεδομένων που είναι εύκολα για επεξεργασία από τον υπολογιστή, για ταχύτητα και ακρίβεια. Για παράδειγμα, μια σαρωμένη φωτοτυπία ενός υπολογιστικού φύλλου δεν θα είναι αναγνώσιμη από μηχάνημα, αλλά ένα αρχείο CSV θα είναι.',
      :pick => :one
    a_false 'no',
      :text_as_statement => ''
    a_true 'yes',
    ...
    a_geographic 'γεωγραφικές πληροφορίες, όπως σημεία και τα όρια',
      :help_text => 'Επιλέξτε αυτό αν τα δεδομένα σας μπορούν να απεικονίζονται σε χάρτη ως σημεία, όρια ή γραμμές.'
    ...
    a_specific 'έχουν σχεδιαστεί για γεωγραφικά δεδομένα όπως <a href="http://www.opengeospatial.org/standards/kml/">KML </a> ή <a href="http://www.geojson.org/">GeoJSON </a>
      ...
      :help_text => 'Αυτές οι μορφές περιγράφουν σημεία, γραμμές και όρια, και εκθέτουν τις δομές στα δεδομένα που καθιστούν ευκολότερη την αυτόματη διαδικασία.',
    ...
    q_provenance 'Παρέχετε αναγνώσιμη από τη μηχανή προέλευση για τα δεδομένα σας;',
      ...
      :help_text => 'Αυτό για την προέλευση του πώς δημιουργήθηκαν τα δεδομένα σας και υπέστησαν επεξεργασία πριν από τη δημοσίευσή τους. Χτίζεται εμπιστοσύνη για τα δεδομένα που δημοσιεύετε επειδή οποιοσδήποτε θα μπορεί να εντοπίζει το πώς έχουν αντιμετωπιστεί.',
  ...
  section_social 'Κοινωνικές Πληροφορίες',
    ...
    q_documentationMetadata 'Μήπως τεκμηρίωση των δεδομένων σας περιλαμβάνει δεδομένα αναγνώσιμα από το μηχάνημα για',
      :discussion_topic => :documentationMetadata,
      :display_on_certificate => true,
      :text_as_statement => 'Η τεκμηρίωση περιλαμβάνει στοιχεία αναγνώσιμα από το μηχάνημα για',
      :pick => :any
    dependency :rule => 'A'
    ...
    label_standard_41 'Θα πρέπει να <strong>συμπεριλάβετε μια κανονική διεύθυνση URL για τα δεδομένα στην αναγνώσιμη από μηχάνημα τεκμηρίωσή σας </strong> έτσι ώστε κάποιος να γνωρίζει πώς να έχει συνεπή πρόσβαση.',
      :custom_renderer => '/partials/requirement_standard',
      :requirement => 'standard_41'
    dependency :rule => 'A and B'
    condition_A :q_documentationUrl, '!=', {:string_value => '', :answer_reference => '1'}
