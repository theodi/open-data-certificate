survey 'AU',
  ...
  :status => 'beta',
  :description => '<p>This self-assessment questionnaire generates an open data certificate and badge you can publish to tell people all about this open data. We also use your answers to learn how organisations publish open data.</p><p>When you answer these questions it demonstrates your efforts to comply with relevant legislation. You should also check which other laws and policies apply to your sector or jurisdiction.</p><p><strong>You do not need to answer all the questions to get a certificate.</strong> Just answer those you can.</p>' do
  ...
  section_legal 'Legal Information',
    ...
    q_publisherRights 'Do you have the rights to publish this data as open data?',
      ...
      :help_text => 'If your organisation did not originally create or gather this data then you may not have the right to publish it as open data. If you are not sure, please check with the data owner for their permission. Open data is data that anyone can access, use and share – subject only, at most, to the requirement to attribute and share-alike – see our page explaining ‘<a href="https://theodi.org/what-is-open-data">what is open data?</a>’ and the <a href="https://opendefinition.org">open definition</a> for more details.',
    ...
    q_publisherOrigin 'Was all the data originally created or generated by you?',
    ...
    q_claUrlPoke 'Where is the contributor licence or waiver?',
      :discussion_topic => :au_claUrlPoke,
      :display_on_certificate => true,
      :text_as_statement => 'The contributor licence or waiver is at',
      :help_text => 'Give a link to a licence or waiver that shows contributors allow you to reuse their data. A agreement will either transfer contributor\'s rights to you, waive their rights, or license the data to you so you can publish it.',
      :help_text_more_url => 'https://en.wikipedia.org/wiki/Contributor_License_Agreement',
      :required => :required
    dependency :rule => 'A and B and C and D'
    condition_A :q_publisherRights, '==', :a_unsure
    condition_B :q_publisherOrigin, '==', :a_false
    ...
    q_cldsRecordedPoke 'Have all contributors agreed to the contributor licence or waiver?',
      :discussion_topic => :au_cldsRecordedPoke,
    ...
    condition_C :q_crowdsourced, '==', :a_true
    condition_D :q_crowdsourcedContent, '==', :a_true
    condition_E :q_cldsRecordedPoke, '==', :a_false
    ...
    q_copyrightURL 'Where have you published the rights statement for this dataset?',
      ...
      :help_text => 'Provide the URL to a page that describes the right to re-use this dataset. This should include a reference to its license, attribution requirements, and a statement about relevant copyright. A rights statement helps people understand what they can and can\'t do with the data.'
    ...
    q_explicitWaiverPoke 'Is the content of the data marked as public domain?',
      :discussion_topic => :au_explicitWaiverPoke,
      :display_on_certificate => true,
      :text_as_statement => 'The content has been',
      :help_text => 'Works in the public domain are those whose intellectual property rights have expired, have been forfeited, or are inapplicable. If none of the content of your data have copyright or other rights over it, it is good practice to explicitly state this by labelling it as ‘public domain’. You can do this by using the <a href="https://creativecommons.org/publicdomain/">Creative Commons Public Domain Mark</a>.',
      :pick => :one
    dependency :rule => 'A'
    ...
    dependency :rule => 'A and B'
    condition_A :q_contentRights, '==', :a_norights
    condition_B :q_explicitWaiverPoke, '==', :a_false
    ...
    q_contentLicence 'Under which licence can others reuse content?',
      ...
      :help_text => 'Remember that whoever spends intellectual effort creating content automatically gets rights over it but creative content does not include facts. So people need a waiver or a licence which proves that they can use the content and explains how they can do that legally. Common licenses are listed here; if there is no copyright in the content, it\'s expired, or you\'ve waived your rights, choose \'Not applicable\'.',
      :pick => :one,
      :required => :required,
    ...
    q_otherContentLicenceOpenPoke 'Is the licence an open licence?',
      :discussion_topic => :au_otherContentLicenceOpenPoke,
      ...
      :help_text_more_url => 'https://opendefinition.org/',
      :pick => :one,
      :required => :required
    dependency :rule => 'A and B'
    condition_A :q_contentRights, '==', :a_samerights
    ...
    condition_A :q_contentRights, '==', :a_samerights
    condition_B :q_contentLicence, '==', :a_other
    condition_C :q_otherContentLicenceOpenPoke, '==', :a_false
    ...
    q_contentRightsURL 'Where are the rights and licensing of the content explained?',
      ...
      :help_text => 'Provide a URL for a page where you describe how someone can find out the rights and licensing of a piece of content from the data.',
      :required => :required
    dependency :rule => 'A'
    ...
    q_dataPersonalPoke 'Is this data is about people or their activities?',
      :discussion_topic => :au_dataPersonalPoke,
      :display_on_certificate => true,
    ...
    q_dataSummarisedPoke 'Has the data is about individuals been de-identified?',
      :discussion_topic => :au_dataSummarisedPoke,
      :display_on_certificate => true,
      :text_as_statement => 'This data has',
      :pick => :one,
      :required => :pilot
    dependency :rule => 'A'
    condition_A :q_dataPersonalPoke, '==', :a_individual
    ...
    q_lawfulDisclosurePoke 'Do you have permission to publish this personal data online? ',
      :discussion_topic => :au_lawfulDisclosurePoke,
      :display_on_certificate => true,
    ...
    dependency :rule => 'A and B'
    condition_A :q_dataPersonalPoke, '==', :a_individual
    condition_B :q_dataSummarisedPoke, '==', :a_no
    a_false 'no',
      :text_as_statement => ''
    a_true 'yes',
    ...
    condition_A :q_dataPersonalPoke, '==', :a_individual
    condition_B :q_dataSummarisedPoke, '==', :a_no
    condition_C :q_lawfulDisclosurePoke, '==', :a_false

    q_lawfulDisclosureURLPoke 'Where do you document your right to publish data about individuals? ',
      :discussion_topic => :au_lawfulDisclosureURLPoke,
      :display_on_certificate => true,
    ...
    condition_A :q_dataPersonalPoke, '==', :a_individual
    condition_B :q_dataSummarisedPoke, '==', :a_no
    condition_C :q_lawfulDisclosurePoke, '==', :a_true
    ...
    condition_B :q_dataSummarisedPoke, '==', :a_no
    condition_C :q_lawfulDisclosurePoke, '==', :a_true
    condition_D :q_lawfulDisclosureURLPoke, '==', {:string_value => '', :answer_reference => '1'}

    q_statisticalAnonAuditedPoke 'Has your de-identification process been independently audited? ',
      :discussion_topic => :au_statisticalAnonAuditedPoke,
      :display_on_certificate => true,
    ...
    dependency :rule => 'A and B'
    condition_A :q_dataPersonalPoke, '==', :a_individual
    condition_B :q_dataSummarisedPoke, '==', :a_yes
    a_false 'no',
    ...
    label_standard_9 'You should <strong>have your de-identification process audited independently</strong> to ensure it reduces the risk of individuals being reidentified.',
      :is_requirement => 'true'
    dependency :rule => 'A and B and C'
    condition_A :q_dataPersonalPoke, '==', :a_individual
    condition_B :q_dataSummarisedPoke, '==', :a_yes
    condition_C :q_statisticalAnonAuditedPoke, '==', :a_false

    q_privacyImpactAssessmentExistsPoke 'Have you assessed the privacy risks of publishing this data? ',
      :discussion_topic => :au_privacyImpactAssessmentExistsPoke,
      :display_on_certificate => true,
    ...
    condition_A :q_dataPersonalPoke, '==', :a_individual
    condition_B :q_dataSummarisedPoke, '==', :a_yes
    condition_C :q_privacyImpactAssessmentExistsPoke, '==', :a_false

    q_privacyImpactAssessmentUrlPoke 'Where is your privacy risk assessment published? ',
      :discussion_topic => :au_privacyImpactAssessmentUrlPoke,
      :display_on_certificate => true,
    ...
    condition_A :q_dataPersonalPoke, '==', :a_individual
    condition_B :q_dataSummarisedPoke, '==', :a_yes
    condition_C :q_privacyImpactAssessmentExistsPoke, '==', :a_true
    ...
    condition_B :q_dataSummarisedPoke, '==', :a_yes
    condition_C :q_privacyImpactAssessmentExistsPoke, '==', :a_true
    condition_D :q_privacyImpactAssessmentUrlPoke, '==', {:string_value => '', :answer_reference => '1'}

    q_piaAuditedPoke 'Has your privacy risk assessment been independently audited? ',
      :discussion_topic => :au_piaAuditedPoke,
      :display_on_certificate => true,
    ...
    label_standard_11 'You should <strong>have your privacy risk assessment audited independently</strong> to ensure it has been carried out correctly.',
      :is_requirement => 'true'
    dependency :rule => 'A and B and C and D'
    condition_A :q_dataPersonalPoke, '==', :a_individual
    condition_B :q_dataSummarisedPoke, '==', :a_yes
    condition_C :q_privacyImpactAssessmentExistsPoke, '==', :a_true
    condition_D :q_piaAuditedPoke, '==', :a_false
    ...
    q_dataBreach 'Are you prepared to respond if publishing this data compromises the privacy of individuals?',
      ...
      :help_text => 'It\'s good practice to be prepared to respond to a potential data breach.',
      :pick => :one,
      :required => :pilot
    dependency :rule => 'A and B'
    condition_A :q_dataPersonalPoke, '==', :a_individual
    ...
    label_standard_12 'You should <strong>provide a quick and effective response if a data breach occurs</strong> by following a plan to contain, assess and manage the incident from start to finish, and prevent a repeat occurence.',
      :is_requirement => 'true'
    dependency :rule => 'A and B and C'
    condition_A :q_dataPersonalPoke, '==', :a_individual
    condition_B :q_dataSummarisedPoke, '==', :a_yes
  ...
  section_technical 'Technical Information',
    ...
    a_1 'Endpoint URL',
      ...
      :corresponding_requirements => ['basic_10', 'standard_28']
