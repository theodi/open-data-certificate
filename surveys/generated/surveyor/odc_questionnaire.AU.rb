survey 'AU',
  ...
  :status => 'beta',
  :description => '<p>This self-assessment questionnaire generates an open data certificate and badge you can publish to tell people all about this open data. We also use your answers to learn how organisations publish open data.</p><p>When you answer these questions it demonstrates your efforts to comply with relevant legislation. You should also check which other laws and policies apply to your sector or jurisdiction.</p><p><strong>You do not need to answer all the questions to earn a certificate.</strong> Just answer those you can.</p>' do
  ...
  section_legal 'Legal Information',
    ...
    q_publisherRights 'Do you have the rights to publish this data as open data?',
      ...
      :help_text => 'If your organisation didn\'t originally create or gather this data then you might not have the right to publish it. If you’re not sure, check with the data owner because you will need their permission to publish it.
				',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#publisherrights',
    ...
    q_rightsRiskAssessment 'Where do you detail the risks people might encounter if they use this data?',
      :discussion_topic => :au_rightsRiskAssessment,
      :display_on_certificate => true,
      :text_as_statement => 'Risks in using this data are described at',
      :help_text => 'It can be risky for people to use data without a clear legal right to do so. For example, the data might be taken down in response to a legal challenge. Provide a URL for a page that describes the risk of using this data.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#rightsriskassessment'
    dependency :rule => 'A'
    ...
    q_publisherOrigin 'Was the data originally created or generated by you?',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#publisherorigins',
      :pick => :one
    ...
    q_thirdPartyOrigin 'Was some of this data extracted or calculated from other data?',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#thirdpartyorigin',
      :pick => :one,
      :required => :required
    dependency :rule => 'A and B'
    ...
    q_thirdPartyOpen 'Are <em>all</em> sources of this data already published as open data?',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#thirdpartyopen',
      :pick => :one,
      :required => :required
    ...
    q_crowdsourced 'Was some of this data crowdsourced?',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#crowdsourced',
      :pick => :one,
      :required => :required
    dependency :rule => 'A and B'
    condition_A :q_publisherRights, '==', :a_unsure
    ...
    q_crowdsourcedContent 'Did contributors to this data use their judgement?',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#crowdsourcedcontent',
      :pick => :one,
      :required => :required
    dependency :rule => 'A and B and C'
    condition_A :q_publisherRights, '==', :a_unsure
    ...
    q_claUrl 'Where is the contributor licence or waiver?',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#claurl',
      :required => :required
    dependency :rule => 'A and B and C and D'
    condition_A :q_publisherRights, '==', :a_unsure
    condition_B :q_publisherOrigin, '==', :a_false
    ...
    q_cldsRecorded 'Have all contributors agreed to the contributor licence or waiver?',
      ...
      :help_text => 'Check all contributors agree to a contributor licence or waiver before you reuse or republish their contributions. You should keep a record of who gave contributions and whether or not they agree to the contributor licence or waiver.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#cldsrecorded',
      :pick => :one,
      :required => :required
    dependency :rule => 'A and B and C and D'
    condition_A :q_publisherRights, '==', :a_unsure
    ...
    q_sourceDocumentationUrl 'Where do you describe sources of this data?',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#sourcedocumentationurl'
    dependency :rule => 'A'
    ...
    label_pilot_3 'You should document <strong>where the data came from and the rights under which you publish it</strong>, so people are assured they can use the parts of the data provided by third parties.',
      :is_requirement => 'true'
    dependency :rule => 'A and B'
    condition_A :q_publisherOrigin, '==', :a_false
    ...
    q_sourceDocumentationMetadata 'Is documentation about the sources of this data also in machine-readable format?',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-rights/#sourcedocumentationmetadata',
      :pick => :one
    dependency :rule => 'A and B'
    condition_A :q_publisherOrigin, '==', :a_false
    condition_B :q_sourceDocumentationUrl, '!=', {:string_value => '', :answer_reference => '1'}
    ...
    q_copyrightURL 'Where have you published the rights statement for this dataset?',
      ...
      :help_text => 'Provide the URL to a page that describes the right to re-use this dataset. This should include a reference to its license, attribution requirements, and a statement about relevant copyright and database rights. A rights statement helps people understand what they can and can\'t do with the data.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#copyrightURL'
    ...
    a_norights 'no, the data only contains facts and numbers',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#contentRights'
    ...
    q_explicitWaiver 'Is the content of the data marked as public domain?',
      ...
      :help_text => 'Works in the public domain are those whose intellectual property rights have expired, have been forfeited, or are inapplicable. If none of the content of your data have copyright or other rights over it, it is good practice to explicitly state this by labelling it as ‘public domain’. You can do this by using the <a href="https://creativecommons.org/share-your-work/public-domain/pdm">Creative Commons Public Domain Mark</a>.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#explicitWaiver',
      :pick => :one
    dependency :rule => 'A'
    ...
    q_contentLicence 'Under which licence can others reuse content?',
      ...
      :help_text => 'Remember that whoever spends intellectual effort creating content automatically gets rights over it but creative content does not include facts. So people need a waiver or a licence which proves that they can use the content and explains how they can do that legally. Common licenses are listed here; if there is no copyright in the content, it\'s expired, or you\'ve waived copyright, choose \'Not applicable\'.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#contentLicence',
      :pick => :one,
      :required => :required,
    ...
    q_contentNotApplicable 'Why doesn\'t a licence apply to the content of the data?',
      :discussion_topic => :au_contentNotApplicable,
      :display_on_certificate => true,
    ...
    a_norights 'there is no copyright in the content of this data',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#contentNotApplicable'
    ...
    q_contentWaiver 'Which waiver do you use to waive copyright?',
      :discussion_topic => :au_contentWaiver,
      :display_on_certificate => true,
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#contentWaiver',
      :pick => :one,
      :required => :required,
      :display_type => 'dropdown'
    dependency :rule => 'A and B and C'
    ...
    q_contentOtherWaiver 'Where is the waiver for the copyright?',
      :discussion_topic => :au_contentOtherWaiver,
      :display_on_certificate => true,
      :text_as_statement => 'Copyright has been waived with',
      :help_text => 'Provide a URL to your own publicly available waiver so people can check that it does waive your copyright.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#otherContentWaiverURL',
      :required => :required
    dependency :rule => 'A and B and C and D'
    condition_A :q_contentRights, '==', :a_samerights
    condition_B :q_contentLicence, '==', :a_na
    ...
    q_otherContentLicenceName 'What\'s the name of the licence?',
      ...
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#otherContentLicenceName',
      :required => :required
    dependency :rule => 'A and B'
    condition_A :q_contentRights, '==', :a_samerights
    ...
    q_otherContentLicenceURL 'Where is the licence?',
      ...
      :help_text => 'Provide a URL to the licence, so people can see it on your Open Data Certificate and check that it\'s publicly available.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#otherContentLicenceURL',
      :required => :required
    dependency :rule => 'A and B'
    condition_A :q_contentRights, '==', :a_samerights
    condition_B :q_contentLicence, '==', :a_other
    ...
    q_otherContentLicenceOpen 'Is the licence an open licence?',
      ...
      :help_text => 'If you aren\'t sure what an open licence is then read the <a href="https://opendefinition.org">Open Definition</a> by Open Knowledge International. Next, choose your licence from the <a href="https://licenses.opendefinition.org">Open Definition Advisory Board open licence list</a>. If a licence isn\'t in their list, it\'s either not open or hasn\'t been assessed yet.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#otherContentLicenceOpen',
      :pick => :one,
      :required => :required
    dependency :rule => 'A and B'
    condition_A :q_contentRights, '==', :a_samerights
    ...
    q_contentRightsURL 'Where are the rights and licensing of the content explained?',
      ...
      :help_text => 'Provide the URL for a page where you describe how someone can find out the rights and licensing of a piece of content from the data.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-licensing/#contentRightsURL',
      :required => :required
    dependency :rule => 'A'
    ...
    q_dataPersonal 'Is this data is about people or their activities?',
    ...
    a_not_personal 'no, the data is not about people or their activities',
      ...
      :help_text => 'Remember that individuals can still be identified even if data isn\'t directly about them.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#dataPersonal'
    a_individual 'yes, there is a risk that individuals can be identified, for example by combining the data with other third party data',
      :text_as_statement => 'information that could identify individuals',
      :help_text => 'Remember that individuals can still be identified even if data isn\'t directly about them.>Some data about individuals may be able to be published online with permission or by law.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#dataPersonal'

    q_dataSummarised 'Has the data is about individuals been de-identified?',
      :discussion_topic => :au_dataSummarised,
      :display_on_certificate => true,
      :text_as_statement => 'This data has',
      :pick => :one,
      :required => :pilot
    dependency :rule => 'A'
    condition_A :q_dataPersonal, '==', :a_individual
    a_yes 'yes, the data been de-identified',
      :text_as_statement => 'been de-identified',
      :help_text => 'Data may be de-identified by deleting or masking personal identifiers, aggregating data or other techniques.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#dataDeidentified'
    a_no 'no, there is a risk that individuals can be identified, for example by third parties with access to extra information',
      :text_as_statement => 'not been de-identified',
      :help_text => 'The law may permit some data about individuals to be published online.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#dataDeidentified'

    q_lawfulDisclosure 'Do you have permission to publish this personal data online?',
      :discussion_topic => :au_lawfulDisclosure,
      :display_on_certificate => true,
      :text_as_statement => 'By law, this data about individuals',
      :help_text => 'You may be able to publish data about individuals online if either, the data is required or permitted to be published by law, or you have permission from the affected individuals.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#lawfulDisclosure',
      :pick => :one
    dependency :rule => 'A and B'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_no
    a_false 'no',
      :text_as_statement => ''
    a_true 'yes',
    ...
    label_pilot_5 'You should <strong>only publish personal data without de-identification if you are required or permitted to do so by law</strong>.',
      :is_requirement => 'true'
    dependency :rule => 'A and B and C'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_no
    ...
    q_lawfulDisclosureURL 'Where do you document your right to publish data about individuals?',
      ...
      :help_text => 'Provide a URL to the law or individual permission that allows you to publish this data about individuals.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#lawfulDisclosureURL'
    dependency :rule => 'A and B and C'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_no
    ...
    label_standard_7 'You should <strong>document your right to publish data about individuals</strong> for people who use your data and for those affected by disclosure.',
      :is_requirement => 'true'
    dependency :rule => 'A and B and C and D'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_no
    ...
    q_statisticalAnonAudited 'Has your de-identification process been independently audited?',
      :discussion_topic => :au_statisticalAnonAudited,
      :display_on_certificate => true,
      :text_as_statement => 'The de-identification process has',
      :help_text => 'It\'s good practice to check your de-identification was done correctly. Independent audits by specialists or third-parties tend to be more rigorous and impartial.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#dataDeidentifiedAudited',
      :pick => :one
    dependency :rule => 'A and B'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_yes
    a_false 'no',
      :text_as_statement => 'not been independently audited'
    a_true 'yes',
      :text_as_statement => 'been independently audited',
      :corresponding_requirements => ['standard_8']

    label_standard_8 'You should <strong>have your de-identification process audited independently</strong> to ensure it reduces the risk of individuals being reidentified.',
      :is_requirement => 'true'
    dependency :rule => 'A and B and C'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_yes
    condition_C :q_statisticalAnonAudited, '==', :a_false

    q_privacyImpactAssessmentExists 'Have you assessed the privacy risks of publishing this data?',
      :discussion_topic => :au_privacyImpactAssessmentExists,
      :display_on_certificate => true,
      :text_as_statement => 'The curator has',
      :help_text => 'You should assess the likelihood of personal data being disclosed and the consequences to individuals of the disclosure.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#riskAssessment',
      :pick => :one
    dependency :rule => 'A and B'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_yes
    a_false 'no',
      :text_as_statement => 'not assessed the privacy risks of publishing this data'
    a_true 'yes',
      :text_as_statement => 'assessed the privacy risks of publishing this data',
      :corresponding_requirements => ['pilot_6']

    label_pilot_6 'You should <strong>assess the privacy risks</strong> if you publish data about individuals.',
      :is_requirement => 'true'
    dependency :rule => 'A and B and C'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_yes
    condition_C :q_privacyImpactAssessmentExists, '==', :a_false

    q_privacyImpactAssessmentUrl 'Where is your privacy risk assessment published?',
      :discussion_topic => :au_privacyImpactAssessmentUrl,
      :display_on_certificate => true,
      :text_as_statement => 'The privacy risk assessment is published at',
      :help_text => 'Provide a URL to where people can check how you have assessed the privacy risks to individuals. This may be redacted or summarised if it contains sensitive information.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#riskAssessmentURL'
    dependency :rule => 'A and B and C'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_yes
    condition_C :q_privacyImpactAssessmentExists, '==', :a_true
    a_1 'Privacy risk assessment URL',
      :text,
      :input_type => :url,
      :placeholder => 'Privacy risk assessment URL',
    ...
    q_piaAudited 'Has your privacy risk assessment been independently audited?',
      :discussion_topic => :au_piaAudited,
      :display_on_certificate => true,
      :text_as_statement => 'The privacy risk assessment has been',
      :help_text => 'It\'s good practice to check your privacy risk assessment was done correctly. Independent audits by specialists or third-parties tend to be more rigorous and impartial.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#riskAssessmentAudited',
      :pick => :one
    dependency :rule => 'A and B and C'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_yes
    ...
    label_standard_10 'You should <strong>have your privacy risk assessment audited independently</strong> to ensure it has been carried out correctly.',
      :is_requirement => 'true'
    dependency :rule => 'A and B and C and D'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_yes
    condition_C :q_privacyImpactAssessmentExists, '==', :a_true
    condition_D :q_piaAudited, '==', :a_false

    q_dataBreach 'Are you prepared to respond if publishing this data compromises the privacy of individuals?',
      :discussion_topic => :au_dataBreach,
      :help_text => 'It\'s good practice to <strong>be prepared to respond to a potential data breach</strong>.',
      :help_text_more_url => 'https://theodi.org.au/open-data-certificate-help-privacy/#breachPrepared',
      :pick => :one,
      :required => :pilot
    dependency :rule => 'A and B'
    condition_A :q_dataPersonal, '==', :a_individual
    ...
    label_standard_11 'You should <strong>provide a quick and effective response if a data breach occurs</strong> by following a plan to contain, assess and manage the incident from start to finish, and prevent a repeat occurence.',
      :is_requirement => 'true'
    dependency :rule => 'A and B and C'
    condition_A :q_dataPersonal, '==', :a_individual
    condition_B :q_dataSummarised, '==', :a_yes
    condition_C :q_dataBreach, '==', :a_false
  ...
  section_technical 'Technical Information',
    ...
    a_1 'Dataset URL',
      ...
      :input_type => :url,
      :placeholder => 'Dataset URL',
      :corresponding_requirements => ['basic_8', 'pilot_12']
