...
survey 'ODI Questionnaire', :default_mandatory => false, :dataset_title => 'dataTitle', :dataset_curator => 'dataTitle' do
  ...
  section 'About' do
    ...
    q_curator "What's the name of the curating organisation?", :required => :required
    a_1 'Data Curator', :string

    q_curator_url "What's the website for the curating organisation?"
    a_1 'Curator URL', :string

    q_releaseType "What kind of data release is this?", :pick => :one, :required => :required
  ...
  section 'Rights' do
    ...
    q_do_you_have_rights 'Do you have the rights to publish the data as open data?', :pick => :one,
    ...
    q_gathered_by_you 'Was all this data originally created or gathered by you?', :pick => :one, :required => :required,
    ...
    q_extracted_and_calculated 'Was some of this data extracted or calculated from other data?', :pick => :one, :required => :required,
    ...
    q_other_data_sources_open 'Are all the other data sources published as open data by their owners?', :pick => :one, :required => :required,
    ...
    q_crowd_sourced 'Was some of this data crowd-sourced?', :pick => :one, :required => :required,
    ...
    q_require_judgement 'Did contributions require judgement?', :pick => :one, :required => :required,
    ...
    q_cla_agreed_by_all 'Have all contributors agreed to the CLA?', :pick => :one, :required => :required,
    ...
    q_sources_of_data 'Where do you describe the sources of the data?',
  ...
  section 'Licensing' do
    ...
    q_which_database_license 'Under which licence can others reuse the data?', :pick => :one, :display_type => :dropdown, :required => :required
    a_0 'choose one...'
    ...
    q_database_license_why_not_applicable 'Why is a licence not applicable for this data?', :pick => :one, :required => :required
    ...
    q_which_database_licence_waiver 'Which waiver are you using to waive database rights?', :pick => :one, :display_type => :dropdown, :required => :required
    a_0 'choose one...'
    ...
    q_database_waiver_location 'Where is the waiver for the database rights?', :required => :required
    a_1 :string
    dependency :rule => 'A'
    condition_A :q_which_database_licence_waiver, '==', :a_other

    q_database_license_name "What's the name of the licence?", :required => :required
    a_1 :string
    dependency :rule => 'A'
    condition_A :q_which_database_license, '==', :a_other

    q_database_license_location "What's the location of the licence?", :required => :required
    a_1 :string
    dependency :rule => 'A'
    condition_A :q_which_database_license, '==', :a_other

    q_is_database_license_open 'Is the licence an open licence?', :pick => :one, :required => :required
    a_yes 'yes'
    a_no 'no'
    dependency :rule => 'A'
    condition_A :q_which_database_license, '==', :a_other
    ...
    q_which_content_license 'Under which licence can others reuse the content?', :pick => :one, :display_type => :dropdown, :required => :required
    a_0 'choose one...'
    ...
    q_content_license_why_not_applicable 'Why is a licence not applicable for this data?', :pick => :one, :required => :required
    ...
    q_which_content_licence_waiver 'Which waiver are you using to waive copyright?', :pick => :one, :display_type => :dropdown, :required => :required
    a_0 'choose one...'
    ...
    q_content_waiver_location 'Where is the waiver for the copyright?', :pick => :one, :required => :required
    a_1 :string
    dependency :rule => 'A'
    condition_A :q_which_content_licence_waiver, '==', :a_other

    q_content_license_name "What's the name of the licence?", :required => :required
    a_1 :string
    dependency :rule => 'A'
    condition_A :q_which_content_license, '==', :a_other

    q_content_license_location "What's the location of the licence?", :required => :required
    a_1 :string
    dependency :rule => 'A'
    condition_A :q_which_content_license, '==', :a_other

    q_is_content_license_open 'Is the licence an open licence?', :pick => :one, :required => :required
    a_yes 'yes'
    a_no 'no'
    dependency :rule => 'A'
    condition_A :q_which_content_license, '==', :a_other
  ...
  section 'Privacy' do
    ...
    q_dataPersonal 'Could the source of this data be personal data under the Data Protection Act?', :pick => :one, :required => :pilot
    ...
    q_consentExempt 'Is this data exempt from the non-disclosure provisions of the Data Protection Act?', :pick => :one, :required => :pilot,
    ...
    q_piaAudited 'Has your Privacy Impact Assessment been independently audited?', :pick => :one,
    ...
    q_personalDataAnonymisation 'Has your anonymisation approach been audited?', :pick => :one,
    ...
    q_privacyImpactAssessment 'Have you carried out a privacy impact assessment?', :pick => :one,
