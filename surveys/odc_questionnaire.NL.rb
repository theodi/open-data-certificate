survey 'NL',
  ...
  section_practical 'Practical Information',
    ...
    label_exemplar_11 'You should <strong>ensure your data does not have more than 9 hours downtime/year</strong> so that people can rely on access to your data.',
      :custom_renderer => '/partials/requirement_exemplar',
      :requirement => 'exemplar_11'
    dependency :rule => 'A and (B)'
    condition_A :q_releaseType, '==', :a_service
  ...
  section_social 'Social Information',
    ...
    label_pilot_22 'You should <strong>provide technical documentation for the data</strong> so that people understand how to use it.',
      :custom_renderer => '/partials/requirement_pilot',
      :requirement => 'pilot_22'
    dependency :rule => 'A'
    ...
    label_pilot_23 'You should <strong>provide contact information for people to send questions</strong> about your data to.',
      :custom_renderer => '/partials/requirement_pilot',
      :requirement => 'pilot_23'
    dependency :rule => 'A'
    ...
    label_pilot_25 'You should <strong>provide contact information for people to send questions about privacy</strong> and disclosure of personal details to.',
      :custom_renderer => '/partials/requirement_pilot',
      :requirement => 'pilot_25'
    dependency :rule => 'A'
