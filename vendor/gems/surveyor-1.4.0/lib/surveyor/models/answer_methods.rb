  ...
  module Models
    module AnswerMethods
      def self.included(base)
        ...
        base.send :attr_accessible, :question, :question_id, :text, :short_text, :help_text, :weight, :response_class, :reference_identifier, :data_export_identifier, :common_namespace, :common_identifier, :display_order, :is_exclusive, :display_length, :custom_class, :default_value, :display_type, :input_mask, :input_mask_placeholder
      end
